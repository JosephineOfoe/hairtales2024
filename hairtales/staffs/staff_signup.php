...
<head>
    ...
    <title>Staffs' SignUp</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <style>
        <?php include '../css/staff_signup.css'; ?>
    </style>
</head>
<body>
<div class="staff-container">
    <div class="form-container">
        <h2>Sign Up</h2>
        <form action="../actions/signup_staff_action.php" method="post" name="signupform" id="signup">
            <div class="entries">
                <label for="fname"><i class="fas fa-user"></i></label>
                <input placeholder="First Name" type="text" class="first" name="first_name" id="fname" pattern="^[A-Za-z\-]+$" required>
                <label for="lname"><i class="fas fa-user-alt"></i></label>
                <input placeholder="Last Name" type="text" class="second" name="last_name" id="lname" pattern="^[A-Za-z\-]+$" required>
                ...
                <button type="submit" name="signupbtn" id="signupbtn">Sign Up as a Staff</button>
                <p>Already have an account? <a href="../staffs/staff_signin.php">Sign In</a></p>
            </div>
        </form>
    </div>
</div>
