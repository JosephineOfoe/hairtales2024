...
<head>
    ...
    <title>Clients' SignIn</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <style>
        <?php include '../css/client_signin.css'; ?>
    </style>
</head>
<body>
<div class="client-container">
    <div class="form-container">
        <h2>Sign In</h2>
        <form action="../actions/signin_client_action.php" method="post" name="signinform" id="signin">
            <div class="entries">
                <label for="email"><i class="fas fa-envelope"></i></label>
                <input placeholder="Email" type="email" name="emailaddress" id="emailaddress" pattern="[a-z._%+\-]+@[a-z.\-]+\.[a-z]{2,}$" required>
                <label for="password"></label><a href="../clients/client_logout.php" id="fgp">Forgot Password?</a>
                ...
                <p>Don't have an account? <a href="../clients/client_signup.php">Sign Up</a></p>
            </div>
        </form>
    </div>
</div>
