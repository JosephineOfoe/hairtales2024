...
include "../actions/get_all_booked_staff_action.php";
...
if (isset($_SESSION['user_id'])) {
    ...
    $clientBookings = getAllBookedStaff();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Staff View of Bookings</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <style>
        <?php include '../css/staff_access.css'; ?>
    </style>
</head>
<body>
...
<div class="container">
    ...
    foreach ($clientBookings as $clientData) {
        ...
        echo "<p><span class='client-name'>Client Name:</span> {$clientData['clientName']}</p>";

        // Loop through bookings
        foreach ($clientData['bookings'] as $booking) {
